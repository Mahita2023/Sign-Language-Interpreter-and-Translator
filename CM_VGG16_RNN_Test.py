...
def LSTMModel(shape=(5, 112, 112, 3), nbout=3):
  ...
  adamax=tf.keras.optimizers.Adamax(learning_rate=0.00005, beta_1=0.999, beta_2=0.99995, epsilon=1e-07, name="Adamax")
...
model.load_weights('chkp/best-weights-RNN-10-5.hdf5')
...
res = predictVideo(
    path='test',
    csv_file='test_datasets//test_2.csv',
    classes=classes,
    verbose=1,
    isOneTime = False)
